...
|---|---:|---:|---:|---:|---:|
| fileio | 35.1 | 18.4 | 15.2 | 144.5 | 615.0 |
| subproc | 92.7 | 121.9 | 105.6 | 163.3 | 1125.3 |
| cpu | 8.2 | 18.2 | 13.3 | 101.8 | 270.4 |
| mixed | 39.0 | 35.7 | 36.8 | 125.3 | 551.8 |

## 解读（论文主张）

**1. 治理开销 ≈ 0（vm+confine / vm）**

fileio 0.83×、subproc 0.87×、cpu 0.73×（聚焦复测 1.08×）、mixed 1.03×
...
- 纯 CPU（整数循环）：~1.5×（1 vCPU guest，宿主负载敏感，多次采样
  1.5-2.2×）；
...
同一负载，docker-exec 比 Terrarium 慢 4-10×，gVisor 一次性沙箱慢
15-40×。原因：docker exec 每次 ~80-100ms CLI/runc 往返，gVisor do
